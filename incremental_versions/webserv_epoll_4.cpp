// created ServerBlock draft, listening on several ports with different config
// objects or each
#include <iostream>
...
//	ServerBlock *block_1 = new ServerBlock(8080, "localhost", "/var/www/site");
//	ServerBlock *block_2 = new ServerBlock(8081, "localhost", "/var/www/site");
	ServerBlock block_1;
	block_1.port = 8080;
	block_1.host = "localhost";
	block_1.root = "/var/wwww/";
	ServerBlock block_2;
	block_2.port = 8081;
	block_2.host = "localhost";
	block_2.root = "/var/wwww/";
