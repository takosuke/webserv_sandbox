*This is `Architecture.md` with the "Subject scope & status" appendix deliberately omitted — use it when you want a description of the system without a list of its known problems. Regenerated 2026-07-29; the full doc is `docs/Architecture.md`, the issue list is `docs/Gaps_and_Issues.md`.*
